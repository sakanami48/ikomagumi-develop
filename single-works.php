  ...
  <main>
    ...
    <div class="p-single">
      <div class="p-single__archives">
        ...
        <div class="p-single__archive">
          <div class="p-single__sections">
            <?php
            $targetNum = get_post_number('works');
            // echo $targetNum;
            $args = [
                'post_type' => 'works',
                'posts_per_page' => '6',
            ...
            $max_pages = $works->max_num_pages;
            if ($works->have_posts()):
                while ($works->have_posts()):

                    $works->the_post();
                    $num = get_post_number('works');
            ...
            <section class="p-single__section">
              <a class="p-single__link js-click <?php if ($num == $targetNum) {
                  echo 'is-active';
                ...
                <div class="p-single__sectionContents">
                  <figure class="p-single__sectionFigure"
                    ...
                    <p class="p-single__sectionCaption c-tag">トンネル</p>
                  </figure>
      ...
      <article class="p-single__article">
        <div id="js-article" class="p-single__articleContents is-show">
          <button id="js-close" class="p-single__close">
            <img src="https://placehold.jp/50x25.png" alt="一覧へ戻る" class="p-single__closeImg">
            <p class="p-single__hiddenTxt">記事を閉じる</p>
            <p class="p-single__closeTxt">一覧へ戻る</p>
          </button>
          <section data-barba="container" data-barba-namespace="single">
